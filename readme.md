...
```text
Create a new [executable|header-only library|library] [with vcpkg] 
called [project_name] from acdemiralp/cmake_templates and apply 
the setup steps from the repository readme.
```
Alternatively:
